...
def text_wrap(raw_text):
    ...
    # 45 char: 2 |, 2 " ", 42 text [2 ' ', line z, x * ' '
    .-------------------------------------------.
    |                                           |
    |                  line1                    |
    |                  line2                    |
...
class StudyCards:
    def __init__(self, group_name):
        ...
        self.card_list = []
        self.data = {'name': f"{self.group_name}"}
    ...
    def save_data(self):
        for card in self.card_list:
            if card.id not in self.data.keys():
                self.data[f"{card.id}_f"] = card.front
                self.data[f"{card.id}_b"] = card.back
            else:
                pass

        with open("flash_store.json", 'w') as f:
    ...
    def load_data(self, filename):
        with open(filename, 'r') as f:
            ...
            pass
        # Need to go come up with a way to neatly d=save all data without losing organize/structure
